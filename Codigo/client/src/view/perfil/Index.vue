...
export default {
    ...
    methods: {
        ...
        isValidPass() {
            return this.passObject.actualPass
    ...
    <div class="flex flex-col gap-6 w-full">
        ...
        <Card class="w-full flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-4">
                ...
                <Input v-model="userData.email" error-message="E-mail inválido" label="E-mail" :disabled="!editing" type="email" />
        ...
        <Dialog v-model="changingPass" @update:model-value="resetPassForm">
            <div class="flex flex-col xs:gap-6 gap-4 p-2">
                ...
                <div class="w-full flex flex-col gap-2">
                    ...
                    <Input v-model="passObject.confirmNewPass" label="Confirme sua nova senha" type="password" class="input-pass" />
                </div>
